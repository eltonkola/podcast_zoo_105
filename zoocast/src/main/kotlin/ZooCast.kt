...
private fun saveFeed(puntate: List<Episode>){
    ...
    feedFile.printWriter().use { out ->
        ...
        out.println("<link>https://eltonkola.github.io/podcast_zoo_105/</link>")
        ...
        out.println("<itunes:summary>Podcast dello zoo di 105 - Unofficial</itunes:summary>")
        out.println("<description>Podcast dello zoo di 105 - con le puntate intere.</description>")
        out.println("<itunes:owner>")
        out.println("    <itunes:name>Marco Mazzoli</itunes:name>")
        out.println("    <itunes:email>eltonkola@gmail.com</itunes:email>")
        out.println("</itunes:owner>")
        out.println("<itunes:explicit>no</itunes:explicit>")
        out.println("<itunes:image href=\"https://eltonkola.github.io/podcast_zoo_105/zoo_cover.jpg\" />")
