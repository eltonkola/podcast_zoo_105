...
print("<itunes:author>misterKola</itunes:author>\n");
print("<itunes:summary>Podcast dello zo di 105 - Unofficial</itunes:summary>\n");
print("<description>Podcast dello zo di 105 - con le punate inetre.</description>\n");
print("<itunes:owner>\n");
